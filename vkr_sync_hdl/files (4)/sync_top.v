...
// Шаг NCO = W_nom + v_pi
// Оба в 16 бит: W_nom в Q0.16, v_pi в Q1.15.
// При малых v_pi (< ±25% от W_nom) прямое сложение 16-битных
// значений даёт правильный результат без масштабирования.
wire signed [W_NCO-1:0] v_pi_wire;
wire [W_NCO-1:0] w_step = reg_w_nom + v_pi_wire;
